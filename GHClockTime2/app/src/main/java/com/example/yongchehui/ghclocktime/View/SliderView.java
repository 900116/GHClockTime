...
public class SliderView extends LinearLayout{
    ...
    private   void  initView() {
        ...
        View.inflate(mContext, R.layout.slider,this);
        mViewContent = (LinearLayout) findViewById(R.id.slider_content);
    ...
    public   void  setButtonText(CharSequence text) {
        ((TextView) findViewById(R.id.slider_deleteTV)).setText(text);
    }
